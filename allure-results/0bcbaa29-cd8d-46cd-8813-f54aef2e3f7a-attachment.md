...
Call log:
  - waiting for locator('//a[@class=\'list-group-item\']').filter({ hasText: 'Forgotten Password' })
...
```ts
  ...
  6  | 
  7  |     const forgotpasswordlink = await page.locator("//a[@class='list-group-item']").filter({ hasText :'Forgotten Password'});
> 8  |     await forgotpasswordlink.click();
     |                              ^ Error: locator.click: Test timeout of 30000ms exceeded.
