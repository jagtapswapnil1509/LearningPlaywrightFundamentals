...
```
Error: locator.click: Unexpected token "#" while parsing css selector "##rs-single". Did you mean to CSS.escape it?
Call log:
  - waiting for ##rs-single
...
```ts
  ...
  6  | 
  7  |     //await page.getByTestId("rs-single").click();
