...
```
Error: locator.fill: Error: strict mode violation: locator('[id=\'pact1\']') resolved to 2 elements:
...
Call log:
  - waiting for locator('[id=\'pact1\']').contentFrame().getByRole('textbox', { name: 'Enter your first crush name' }).first()
...
```ts
  ...
  6  |     await page.pause();
  7  |     let frame:FrameLocator = await page.frameLocator("[id='pact1']");
  8  | 
> 9  |     frame.getByRole('textbox',{name:"Enter your first crush name"}).first().fill("abcd");
     |                                                                             ^ Error: locator.fill: Error: strict mode violation: locator('[id=\'pact1\']') resolved to 2 elements:
  10 | 
  11 |     await page.pause();
  12 | 
