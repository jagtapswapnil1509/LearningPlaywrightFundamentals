...
- Name: 19_Data_Driven_Testing\296_DDT_JsonArray.spec.ts >> DDT Simple >> login with : valid credentials
- Location: tests\19_Data_Driven_Testing\296_DDT_JsonArray.spec.ts:50:9
...
```ts
  ...
  8  | 
  9  |     });
  10 |     // Test data - array of objects
  11 |     const loginData = [
  12 |         {
  13 |             description: "valid credentials",
  14 |             username: "admin@gmail.com",
  15 |             password: "admin123",
  16 |             expectedURL: /admin/,
  17 |             shouldPass: true
  18 |         },
  19 |         {
  20 |             description: "invalid password",
  21 |             username: "admin123@ymail.com",
  22 |             password: "wrongpass",
  23 |             expectedURL: /admin/,
  24 |             shouldPass: false
  25 |         },
  26 |         {
  27 |             description: "empty username",
  28 |             username: "",
  29 |             password: "admin123",
  30 |             expectedURL: /admin123/,
  31 |             shouldPass: false
  32 |         },
  33 |         {
  34 |             description: "empty password",
  35 |             username: "pramod@ppp.com",
  36 |             password: "",
  37 |             expectedURL: /admin/,
  38 |             shouldPass: false
  39 |         },
  40 |         {
  41 |             description: "both empty",
  42 |             username: "",
  43 |             password: "",
  44 |             expectedURL: /multiple_element_filter/,
  45 |             shouldPass: false
  46 |         }
  47 |     ];
  48 | 
  49 |     for(const data of loginData){
  50 |         test(`login with : ${data.description}`,async ({page})=>{
> 51 |             await page.locator('').fill(data.username);
     |                                    ^ Error: locator.fill: Unexpected token "" while parsing css selector "". Did you mean to CSS.escape it?
  52 |             await page.locator('').fill(data.password);
