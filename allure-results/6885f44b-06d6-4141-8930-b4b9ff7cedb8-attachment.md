...
```ts
  ...
  11 |     const pricelocator:Locator = page.locator("//div[@class='QiMO5r']/div");
  12 |     let countnumber:number=await pricelocator.count();
  13 |     for(let i=0;i<countnumber;i++){
> 14 |         const priceofeachitem:string|null = await page.locator("//div[@class='QiMO5r']/div").nth(i).textContent();
     |                                                                                                 ^ Error: locator.textContent: Target page, context or browser has been closed
