...
Call log:
  - waiting for getByTestId('rs-single')
    - locator resolved to <div class="tta-rs" id="rs-single" data-mode="single" data-searchable="true" data-testid="rs-single">…</div>
    - fill("Selenium")
...
> 10 |     await page.getByTestId("rs-single").fill("Selenium");
     |                                         ^ Error: locator.fill: Error: Element is not an <input>, <textarea>, <select> or [contenteditable] and does not have a role allowing [aria-readonly]
