...
- Name: PlaywrightCodePractice\01_Basics_Browser_Context_Page.spec.ts >> validate page title
- Location: tests\PlaywrightCodePractice\01_Basics_Browser_Context_Page.spec.ts:6:1
...
```ts
  1  | //Task 1.1 — Write a test that launches Chromium, 
  2  | // navigates to https://playwright.dev, and asserts the page title contains "Playwright".
  3  | 
  4  | import {test , expect} from '@playwright/test';
  5  | 
  6  | test('validate page title', async({page})=>{
