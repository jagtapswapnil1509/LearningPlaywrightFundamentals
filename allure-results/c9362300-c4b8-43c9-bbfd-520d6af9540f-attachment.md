...
- Name: 08_Web_Select_Frames_Iframe\261_Advance_dropdown.spec.ts >> Verify select from the custom dropdown
- Location: tests\08_Web_Select_Frames_Iframe\261_Advance_dropdown.spec.ts:3:1

# Error details

```
Error: locator.fill: Error: strict mode violation: locator('//input[@type=\'text\']') resolved to 5 elements:
    1) <input type="text" aria-label="Filter options" data-testid="rs-single-input"/> aka getByTestId('rs-single-input')
    2) <input type="text" aria-label="Filter options" data-testid="rs-multi-input"/> aka getByTestId('rs-multi-input')
    3) <input type="text" aria-label="Add a tag" data-testid="rs-creatable-input"/> aka getByTestId('rs-creatable-input')
    4) <input type="text" aria-label="Filter options" data-testid="rs-grouped-input"/> aka getByTestId('rs-grouped-input')
    5) <input type="text" aria-label="Search cities" data-testid="rs-async-input"/> aka getByTestId('rs-async-input')
        ...
        - region "Select box variants workspace" [ref=e536]:
          - generic [ref=e537]:
            ...
            - generic [ref=e564]:
              ...
              - generic [ref=e570]:
                - generic [ref=e571]:
                  - generic [ref=e572]: Pick automation tools…
                  - textbox "Filter options" [ref=e574]
                - generic [ref=e575]:
                  - button "Clear values" [ref=e576] [cursor=pointer]:
                    - img [ref=e577]
                  - img [ref=e581]
              - generic [ref=e583]:
                - generic [ref=e584]:
                ...
                - generic [ref=e586]:
                  - generic [ref=e587]: chip
                  - text: =tta-rs__multi-value
                - generic [ref=e588]:
                  - generic [ref=e589]: remove
                  - text: =tta-rs__multi-value__remove
            - generic [ref=e590]:
              - generic [ref=e591]:
                - heading "③ Creatable multi — type and Enter" [level=2] [ref=e592]
                - generic [ref=e593]: Add new options
              - paragraph [ref=e594]:
              ...
              - generic [ref=e597]:
                - generic [ref=e598]:
                  - generic [ref=e599]: Add skill tags…
                  - textbox "Add a tag" [ref=e601]
                - generic [ref=e602]:
              ...
              - generic [ref=e610]:
                ...
                - generic [ref=e613]:
                  - generic [ref=e614]: create
                  - text: =press Enter
            - generic [ref=e615]:
              - generic [ref=e616]:
                - heading "④ Grouped — categorised options" [level=2] [ref=e617]
                - generic [ref=e618]: Groups
              - paragraph [ref=e619]: Options are split into labelled groups. Practise reaching an option inside a specific group heading.
              - generic [ref=e621]:
                - generic [ref=e622]:
                  - generic [ref=e623]: Pick a deployment target…
                  - textbox "Filter options" [ref=e625]
                - img [ref=e629]
              - generic [ref=e631]:
                - generic [ref=e632]:
                  - generic [ref=e633]: data-testid
                  - text: =rs-grouped
                - generic [ref=e634]:
            ...
            - generic [ref=e636]:
              - generic [ref=e637]:
                - heading "⑤ Async — fetched on type" [level=2] [ref=e638]
                - generic [ref=e639]: 600ms latency
              - paragraph [ref=e640]:
                - text: Type a city name. Results load after a simulated 600ms network call. Practise
                - code [ref=e641]: page.waitForResponse
                - text: patterns or just await a visible option.
              - generic [ref=e643]:
                - generic [ref=e644]:
                  - generic [ref=e645]: Type to search cities…
                  - textbox "Search cities" [ref=e647]
                - img [ref=e650]
              - generic [ref=e652]:
                - generic [ref=e653]:
                  - generic [ref=e654]: data-testid
                  - text: =rs-async · rs-async-input · rs-async-menu
                - generic [ref=e655]:
                  - generic [ref=e656]: state
                  - text: =loading / no-results / results
            - generic [ref=e657]: No selection yet — interact with the variants above.
          - complementary [ref=e658]:
            - generic [ref=e659]:
              - heading "What students should practise" [level=3] [ref=e660]
              - list [ref=e661]:
                - listitem [ref=e662]:
                  - text: Click
                  - code [ref=e663]: .tta-rs__control
                  - text: to open, then click
                  - code [ref=e664]: .tta-rs__option
                  - text: by visible text.
                - listitem [ref=e665]:
                  - text: Type into
                  - code [ref=e666]: .tta-rs__input-container input
                  - text: to filter options.
                - listitem [ref=e667]:
                  - text: "Multi: remove a chip via its"
                  - code [ref=e668]: .tta-rs__multi-value__remove
                  - text: button.
                - listitem [ref=e669]: "Creatable: type a brand-new value and press Enter; assert the chip appears."
                - listitem [ref=e670]:
                  - text: "Grouped: scope a query under a specific"
                  - code [ref=e671]: .tta-rs__group[data-group="Edge"]
                  - text: .
                - listitem [ref=e672]: "Async: wait for the loading notice to disappear, then click the result."
            - group [ref=e673]:
              - generic "Playwright solutions One snippet per variant. Show solution" [ref=e674] [cursor=pointer]:
                - img [ref=e676]
                - generic [ref=e678]:
                  - strong [ref=e679]: Playwright solutions
                  - generic [ref=e680]: One snippet per variant.
                - generic [ref=e681]: Show solution
```
...
```ts
  ...
  2  | 
  3  | test('Verify select from the custom dropdown',async ({page}) => {
  4  | 
  5  |     await page.goto("https://app.thetestingacademy.com/playwright/tables/select-boxes");
  6  | 
  7  |     // Example 1 
  8  |     //await page.getByTestId("rs-single").click();
  9  |     //await page.locator("#rs-single").click();
> 10 |     await page.locator("//input[@type='text']").fill("Selenium");
     |                                                 ^ Error: locator.fill: Error: strict mode violation: locator('//input[@type=\'text\']') resolved to 5 elements:
  11 |     await page.getByRole("option",{name:"Selenium"}).click();
  12 | 
  13 |     // Example 2 
  14 | 
  15 | 
